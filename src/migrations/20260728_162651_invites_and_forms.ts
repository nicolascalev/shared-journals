...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  ALTER TABLE "events" ADD COLUMN "invite_description" jsonb;
  ALTER TABLE "events" ADD COLUMN "invite_form_id" integer;
  ...
  ALTER TABLE "form_submissions" ADD CONSTRAINT "form_submissions_event_id_events_id_fk" FOREIGN KEY ("event_id") REFERENCES "public"."events"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "form_submissions" ADD CONSTRAINT "form_submissions_member_id_members_id_fk" FOREIGN KEY ("member_id") REFERENCES "public"."members"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "form_submissions_event_idx" ON "form_submissions" USING btree ("event_id");
  CREATE INDEX "form_submissions_member_idx" ON "form_submissions" USING btree ("member_id");
  CREATE INDEX "form_submissions_updated_at_idx" ON "form_submissions" USING btree ("updated_at");
  CREATE INDEX "form_submissions_created_at_idx" ON "form_submissions" USING btree ("created_at");
  ALTER TABLE "events" ADD CONSTRAINT "events_invite_form_id_forms_id_fk" FOREIGN KEY ("invite_form_id") REFERENCES "public"."forms"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "events_invite_form_idx" ON "events" USING btree ("invite_form_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  ALTER TABLE "events" DROP CONSTRAINT "events_invite_form_id_forms_id_fk";
  ...
  DROP INDEX "events_invite_form_idx";
  ...
  ALTER TABLE "events" DROP COLUMN "invite_description";
  ALTER TABLE "events" DROP COLUMN "invite_form_id";
